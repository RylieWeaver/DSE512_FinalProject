...
#SBATCH -A LRN036
#SBATCH -J FineTuning
#SBATCH -o finetuning_log/%j/slurm.o
#SBATCH -e finetuning_log/%j/slurm.e
#SBATCH -t 02:00:00
#SBATCH -p batch
##SBATCH -q debug
#SBATCH -N 32
...
export CKPT_DIR="/lustre/orion/lrn036/proj-shared/rylieweaver/checkpoints/Microbial/FineTune/"
export FINETUNE_FROM="/lustre/orion/lrn036/proj-shared/rylieweaver/checkpoints/Microbial/Final_Pretrain/step_7800"
export LOG_DIR="${REPO_DIR}/experiments/finetune_log"
